...
#[no_mangle]
pub extern "C" fn payment_parameters_from_variable_amount_invoice(invoice: &crate::lightning_invoice::Bolt11Invoice, mut amount_msat: u64) -> crate::c_types::derived::CResult_C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZNoneZ {
	let mut ret = lightning::ln::bolt11_payment::payment_parameters_from_variable_amount_invoice(invoice.get_native_ref(), amount_msat);
